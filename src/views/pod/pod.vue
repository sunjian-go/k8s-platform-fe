            ...
            <div >
              <el-table :data="podList" style="width: 100%">
                ...
                <el-table-column  label="标签"  align="left">
                  <template v-slot="scope">
                    <div v-for="(label,i) in scope.row.metadata.labels" :key="i">
                      <span>{{ i }}: {{label }}</span>
                    </div>
                  </template>
                </el-table-column>
                <el-table-column  label="容器组" align="left">
                  <template v-slot="scope">
                    <div v-for="(container,i) in scope.row.spec.containers" :key="i">
                ...
                <el-table-column  label="创建时间" align="left">
                  <template v-slot="scope"> 
                      <span>{{timeTrans(scope.row.metadata.creationTimestamp)}}</span>                   
                  </template>
                </el-table-column>
                ...
                <el-table-column >
                  <template #header>
                    <el-row :gutter="150">
                      ...
                      ></el-col>
                      <el-col :span="2"
                        ><el-button type="" @click="getPodList()">搜索</el-button></el-col
                      >
                    </el-row>
                  </template>
                </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getPodList(){
      ...
      httpClient.get(this.getPodListData.url,{
