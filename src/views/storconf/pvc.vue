...
export default {
  ...
  methods: {
    ...
    updatePVC() {
      ...
      httpClient
        .put(this.updatePVCData.url, this.updatePVCData.params)
        .then((res) => {
          this.$message({
            type: "success",
    ...
    getPVCDetail(obj) {
      ...
      httpClient
        .get(this.pvcDetailData.url, {
          params: this.pvcDetailData.params,
        })
        .then((res) => {
    ...
    createPVCFunc() {
      ...
      // 组装好类型一样的数据
      this.createPVCData.params.name = this.createPVC.name;
      this.createPVCData.params.namespace = this.createPVC.namespace;
      this.createPVCData.params.type = this.createPVC.type;
      this.createPVCData.params.container_port = parseInt(
        this.createPVC.container_port
      );
      this.createPVCData.params.port = parseInt(this.createPVC.port);
      this.createPVCData.params.node_port = parseInt(this.createPVC.node_port);
      this.createPVCData.params.label = label;
      console.log("组装数据：", this.createPVCData.params);

      // 组装好数据后开始创建
      httpClient
        .post(this.createPVCData.url, this.createPVCData.params)
        .then((res) => {
    ...
    getPVCs() {
      ...
      httpClient
        .get(this.getPVCData.url, {
          params: this.getPVCData.params,
        })
        .then((res) => {
    ...
    deletePVC(pvc) {
      ...
      //return;
      httpClient
        .delete(this.deletePVCData.url, {
          params: this.deletePVCData.params,
        })
        .then((res) => {
          this.$message({
            type: "success",
